...
import { PeriodPickerLocale, PeriodPickerLocaleHelper } from './locale';
...
export interface PeriodPickerProps
   ...
   */
  useMobileNativePeriodPicker?: boolean;
}

export interface PeriodPickerState {
  opened: boolean;
  canUseMobileNativePeriodPicker: boolean;
  today: CalendarDateShape;
}

export const PeriodPickerDataTids = {
  root: 'PeriodPicker__root',
  input: 'PeriodPicker__input',
  label: 'PeriodPicker__label',
  pickerRoot: 'Picker__root',
  pickerTodayWrapper: 'Picker__todayWrapper',
} as const;

type DefaultProps = Required<Pick<PeriodPickerProps, 'minDate' | 'maxDate'>>;

@responsiveLayout
@rootNode
@locale('PeriodPicker', PeriodPickerLocaleHelper)
export class PeriodPicker extends React.PureComponent<PeriodPickerProps, PeriodPickerState> {
  public static __KONTUR_REACT_UI__ = 'PeriodPicker';
  public static displayName = 'PeriodPicker';
  ...
  private getProps = createPropsGetter(PeriodPicker.defaultProps);
  private theme!: Theme;
  private calendar: Calendar | null = null;
  private readonly locale!: PeriodPickerLocale;
  ...
  public state: PeriodPickerState = { opened: false, canUseMobileNativePeriodPicker: false, today: getTodayDate() };
  ...
  public componentDidMount() {
    if (this.props.useMobileNativePeriodPicker && isMobile) {
      this.setState({
        canUseMobileNativePeriodPicker: true,
      });
    }
  ...
  public renderMain = (props: CommonWrapperRestProps<PeriodPickerProps>) => {
    let picker = null;
        ...
        picker = (
          ...
          >
            <DropdownContainer
              ...
              data-tid={PeriodPickerDataTids.root}
              getParent={this.getParent}
              offsetY={parseInt(this.theme.datePickerMenuOffsetY)}
              align={this.props.menuAlign}
            >
              <div
                data-tid={PeriodPickerDataTids.pickerRoot}
    ...
    return (
      <label
        ...
        data-tid={PeriodPickerDataTids.label}
      >
        <DateInput
          ...
          onValueChange={this.props.onValueChange}
          data-tid={PeriodPickerDataTids.input}
        />
        {this.state.canUseMobileNativePeriodPicker ? (
          <NativeDateInput
            onValueChange={this.props.onValueChange}
            value={this.props.value || ''}
            minDate={minDate}
      ...
      return (
        <div style={{ margin: 8 }}>
          <Button
            ...
            data-tid={PeriodPickerDataTids.pickerTodayWrapper}
            width="100%"
